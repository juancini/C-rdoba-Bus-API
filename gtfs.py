...
GTFS_URL = "https://hub.tumidata.org/dataset/da667fd9-fea3-41f5-b34f-5f855cf68081/resource/f934d705-3d6f-45b9-9aef-5ae014dcd382/download/gtfs.zip"
...
class GTFSData:
    ...
    def stops_for_route(self, route_id: str) -> list:
        ...
        trip = next(
            (t for t in self.trips.values() if t["route_id"] == route_id), None
        )
        if not trip:
            return []
